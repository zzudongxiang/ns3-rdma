...
As seen above, the following command only build the requested modules (core and wifi), 
...
The first command will generally lead to a shorter build time, but the second option will providing better
